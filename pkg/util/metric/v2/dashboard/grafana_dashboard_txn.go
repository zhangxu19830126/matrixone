	...
	return dashboard.Row(
		...
		c.getMultiHistogram(
			[]string{
				...
				c.getMetricWithFilter(`mo_txn_lock_duration_seconds_bucket`, `type="acquire-do"`),
				c.getMetricWithFilter(`mo_txn_lock_duration_seconds_bucket`, `type="acquire-wait"`),
				c.getMetricWithFilter(`mo_txn_lock_duration_seconds_bucket`, `type="acquire-local"`),
				c.getMetricWithFilter(`mo_txn_lock_duration_seconds_bucket`, `type="acquire-remote"`),
				c.getMetricWithFilter(`mo_txn_lock_duration_seconds_bucket`, `type="acquire-remote-cb"`),
