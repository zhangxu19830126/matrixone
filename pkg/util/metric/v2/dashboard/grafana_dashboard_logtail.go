	...
	return dashboard.Row(
		...
		c.getMultiHistogram(
			[]string{
				...
				c.getMetricWithFilter(`mo_logtail_apply_duration_seconds_bucket`, `step="apply-get-lock"`),
				c.getMetricWithFilter(`mo_logtail_apply_duration_seconds_bucket`, `step="apply-get-mutation"`),
				c.getMetricWithFilter(`mo_logtail_apply_duration_seconds_bucket`, `step="apply-get-catalog"`),
				c.getMetricWithFilter(`mo_logtail_apply_duration_seconds_bucket`, `step="apply-lazy-load"`),
				c.getMetricWithFilter(`mo_logtail_apply_duration_seconds_bucket`, `step="apply-without-lazy-load"`),
				c.getMetricWithFilter(`mo_logtail_apply_duration_seconds_bucket`, `step="apply-mutation"`),
